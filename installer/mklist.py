...
comment("Docs")
#docs are built, so they come out of the dist directory
listfiles("../dist", "Doc", '*.html')
binary("Doc/images/jython-new-small.gif")
binary("Doc/images/PythonPoweredSmall.gif")
listfiles("../dist", "Doc/javadoc", '*.html', '*.css')
listfiles("../dist", "Doc/javadoc/org/python/core", '*.html')
listfiles("../dist", "Doc/javadoc/org/python/util", '*.html')
listfiles("../dist", "Doc/javadoc/com/ziclix/python/sql", '*.html')
...
binary("org/python/modules/ucnhash.dat")
...
# xml files are copied to the dist directory
listfiles("../dist", "Lib/xml", "*.py")
listfiles("../dist", "Lib/xml/sax", "*.py")
listfiles("../dist", "Lib/xml/dom", "*.py")
listfiles("../dist", "Lib/xml/dom/html", "*.py")
listfiles("../dist", "Lib/xml/parsers", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/dom", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/dom/ext", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/dom/ext/reader", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/dom/html", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/marshal", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/parsers", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/parsers/xmlproc", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/sax", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/sax/drivers", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/sax/drivers2", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/schema", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/unicode", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/utils", "*.py")
listfiles("../dist", "Lib/site-packages/_xmlplus/xpath", "*.py")
